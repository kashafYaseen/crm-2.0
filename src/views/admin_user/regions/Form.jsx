  ...
  if (SessionStore.initialized) {
    ...
    useEffect(() => {
      ...
      const fetch_data = async () => {
        try {
          const extractCountriesData = await countries_data(
            'get',
            'countries',
            null,
            null,
                    ...
                    <CForm className="row g-3" onSubmit={formik.handleSubmit}>
                      ...
                      <CCol md={6}>
                        ...
                        <CFormInput
                          ...
                          className={
                            formik.errors.region?.meta_title_en &&
                            formik.touched.region?.meta_title_en
                              ? 'input-error'
                              : ''
                          }
                        />
                      ...
                      <CCol md={6}>
                        ...
                        <CFormInput
                          ...
                          className={
                            formik.errors.region?.meta_title_nl &&
                            formik.touched.region?.meta_title_nl
                              ? 'input-error'
                              : ''
                          }
                        />
                      ...
                      <CCol md={6}>
                        ...
                        />
                        {formik.touched.region?.villas_desc &&
                          formik.errors.region?.villas_desc && (
