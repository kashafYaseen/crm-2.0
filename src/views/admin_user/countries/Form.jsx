                  ...
                  <CCardBody>
                    <CForm className="row g-3" onSubmit={formik.handleSubmit}>
                      ...
                      <CCol md={6}>
                        ...
                        />
                        {formik.touched.country?.content_en &&
                          formik.errors.country?.content_en && (
                      ...
                      <CCol md={6}>
                        ...
                        />
                        {formik.touched.country?.content_nl &&
                          formik.errors.country?.content_nl && (
                      ...
                      <CCol md={6}>
                        ...
                        <CFormTextarea
                          ...
                          className={
                            formik.errors.country?.villas_desc &&
                            formik.touched.country?.villas_desc
                              ? 'input-error'
                              : ''
                          }
                        />
